...
- Quickstart TTY screen transitions clear only the visible terminal area, do
  not emit a scrollback-clearing escape, and reprint the selected source
  context on the validation/start screen; redirected, non-TTY, and opted-out
  runs do not emit screen clears.
